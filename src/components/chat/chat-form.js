    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
      <div className="relative w-full">
        <Textarea
          ...
          className={`mendable-textarea resize-none ${textareaHeight} pr-12 w-full min-h-[50px] p-3 rounded-lg border-2 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all`}
        />
        {browserSupportsSpeechRecognition && (
          <Button
            type="button"
            variant="ghost"
            size="icon"
            className="absolute right-3 top-1/2 -translate-y-1/2 hover:bg-gray-100 rounded-full p-2"
